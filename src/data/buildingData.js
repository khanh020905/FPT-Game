  ...
  "gamma-tower": {
    ...
    floors: {
      ...
      list: [
        {
          floor: 1,
          name: "Tầng 1 — Thư Viện & Khu Chức Năng",
          emoji: "🟠",
          color: "#f37021",
          description:
            "Thư viện với đa dạng tài liệu học tập và tham khảo. Không gian tự học yên tĩnh, phù hợp cho nghiên cứu. Khu vực chức năng hỗ trợ sinh viên trong học tập.",
          highlights: [
            "Thư viện với đa dạng tài liệu học tập và tham khảo",
            "Không gian tự học yên tĩnh, phù hợp cho việc nghiên cứu",
            "Khu vực chức năng hỗ trợ sinh viên trong học tập",
            "Nơi sinh viên có thể đọc sách, học nhóm và thư giãn",
          ],
        },
        {
          floor: 2,
          name: "Tầng 2 — Phòng Học",
          emoji: "🔵",
          color: "#2563eb",
          description:
            "Các lớp học cơ bản dành cho nhiều môn khác nhau. Phòng học rộng, đầy đủ tiện nghi và thiết bị hỗ trợ. Môi trường học tập thoải mái, thân thiện.",
          highlights: [
            "Các lớp học cơ bản dành cho nhiều môn khác nhau",
            "Phòng học rộng, đầy đủ tiện nghi và thiết bị hỗ trợ",
            "Môi trường học tập thoải mái, thân thiện",
            "Phù hợp cho các hoạt động học tập hằng ngày của sinh viên",
          ],
        },
        {
          floor: 3,
          name: "Tầng 3 — Phòng Học",
          emoji: "🟢",
          color: "#16a34a",
          description:
            "Khu vực lớp học chính với nhiều phòng học tiêu chuẩn. Không gian học tập rộng rãi, thoáng mát. Được thiết kế phù hợp cho cả học cá nhân và học nhóm.",
          highlights: [
            "Khu vực lớp học chính với nhiều phòng học tiêu chuẩn",
            "Không gian học tập rộng rãi, thoáng mát",
            "Được thiết kế phù hợp cho cả học cá nhân và học nhóm",
            "Hỗ trợ sinh viên làm bài tập, trao đổi và thảo luận",
          ],
        },
        {
          floor: 4,
          name: "Tầng 4 — Phòng Học",
          emoji: "🟣",
          color: "#7c3aed",
          description:
            "Các phòng học lý thuyết dành cho nhiều môn chuyên ngành. Trang bị đầy đủ máy chiếu, bảng viết và hệ thống âm thanh. Không gian học tập hiện đại.",
          highlights: [
            "Các phòng học lý thuyết dành cho nhiều môn chuyên ngành",
            "Trang bị đầy đủ máy chiếu, bảng viết và hệ thống âm thanh",
            "Không gian học tập hiện đại, hỗ trợ giảng dạy hiệu quả",
            "Phù hợp cho học tập, thuyết trình và thảo luận nhóm",
          ],
        },
        {
          floor: 5,
