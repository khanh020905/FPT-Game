...
import ADaySection from "./ADaySection";
...
const IMGS = {
  ...
  "gamma-tower": [
    ...
    {
      url: "https://chungta.vn/uploaded/nguyennhung/2023_08_18/3_CTMG.jpg",
  ...
  return (
    <div
      ...
      style={{
        ...
        background: "#ffffff",
        opacity: exit ? 0 : 1,
        transform: exit ? "scale(.96)" : "scale(1)",
...
.gp{font-family:'Inter',system-ui,sans-serif;color:#1e293b;-webkit-font-smoothing:antialiased}
...
@keyframes gGlow{0%,100%{box-shadow:0 0 20px #f3702120}50%{box-shadow:0 0 40px #f3702140}}
@keyframes gSpin{from{transform:rotate(0)}to{transform:rotate(360deg)}}
.gF{animation:gFU .65s ease both}
.gG{background:#fff;border:1px solid #e2e8f0;border-radius:16px;backdrop-filter:blur(16px);transition:all .3s cubic-bezier(.4,0,.2,1)}
.gG:hover{background:#fff;border-color:#f3702140;transform:translateY(-3px);box-shadow:0 12px 32px rgba(0,0,0,.08)}
...
.gIC{position:relative;overflow:hidden;border-radius:16px;border:1px solid #e2e8f0}
...
.gIC:hover img{transform:scale(1.04)}
      ...
      {/* NAV — Floating dark glassmorphism pill */}
      <div
        style={{
          position: "sticky",
          top: 0,
      ...
      >
        <nav
          style={{
            ...
            maxWidth: 1200,
            margin: "0 auto",
            background: "rgba(30,35,50,.4)",
            backdropFilter: "blur(24px) saturate(1.8)",
            borderRadius: 100,
            border: "1px solid rgba(255,255,255,.08)",
            boxShadow:
              "0 4px 30px rgba(0,0,0,.25), inset 0 1px 0 rgba(255,255,255,.04)",
            pointerEvents: "auto",
            overflow: "hidden",
          }}
        >
          {/* Subtle glow accent under nav */}
          <div
            style={{
              position: "absolute",
              bottom: -1,
              ...
              height: 1,
              background:
                "linear-gradient(90deg, transparent, rgba(56,189,248,.35) 30%, rgba(243,112,33,.4) 50%, rgba(168,85,247,.3) 70%, transparent)",
              pointerEvents: "none",
            }}
          />
          ...
          >
            {["Tổng quan", "Lịch trình", "Hoạt động", "Thư viện ảnh"].map(
              (label, i) => (
                <a
                  key={label}
                  href={["#gallery", "#schedule", "#features", "#gallery"][i]}
                  style={{
                    padding: "6px 16px",
                    borderRadius: 100,
                    fontSize: 13,
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(180deg,rgba(255,255,255,.0) 0%,rgba(255,255,255,.1) 40%,rgba(255,255,255,.7) 75%,#ffffff 100%)",
          }}
        />
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 20% 90%,rgba(243,112,33,.12),transparent 55%)",
          }}
        />
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 80% 20%,rgba(243,112,33,.06),transparent 50%)",
          }}
        />
        {/* Orange line accents */}
        <div
          style={{
            ...
            height: "60%",
            background:
              "linear-gradient(to bottom,transparent,#f3702120,transparent)",
            opacity: 0.6,
          }}
        />
        <div
          style={{
            ...
            height: "50%",
            background:
              "linear-gradient(to bottom,transparent,#f3702115,transparent)",
            opacity: 0.4,
          }}
        />
          ...
          >
            <a
              ...
              style={{
                ...
                textDecoration: "none",
                boxShadow:
                  "0 4px 24px rgba(243,112,33,.4),0 0 0 1px rgba(243,112,33,.2)",
                transition: "all .25s",
              }}
            >
              📅 Lịch Trình 1 Ngày
            ...
            {isG && (
              <a
                ...
                style={{
                  ...
                  borderRadius: 12,
                  color: "#f37021",
                  border: "1.5px solid rgba(243,112,33,.25)",
              ...
              {imgs.map((_, i) => (
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    background:
                      i === imgIdx ? "#f37021" : "rgba(255,255,255,.15)",
                    transition: "all .4s",
                  }}
                />
              ))}
      ...
      {/* ═══ GALLERY ═══ */}
      {imgs.length > 1 && (
        <section style={{ padding: "0 clamp(16px,4vw,40px) 64px" }}>
          <div
            style={{
              maxWidth: 1040,
              margin: "0 auto",
            ...
            {imgs.map((img, i) => (
              <div
                ...
                style={{
                  height: 160,
                  cursor: "pointer",
                  outline: i === imgIdx ? "2px solid #f37021" : "none",
                  outlineOffset: 2,
                  borderRadius: 14,
                }}
              >
                  ...
                  <>
                    ...
                    <div
                      style={{
                        ...
                        inset: 0,
                        background:
                          "linear-gradient(180deg,transparent 40%,rgba(0,0,0,.8))",
                      }}
                    />
                    <p
                      style={{
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg,rgba(243,112,33,.02),transparent)",
        }}
      >
        <div className="gS">
          ...
          >
            <div
              style={{
                ...
                width: 2,
                background:
                  "linear-gradient(to bottom,#f3702140,#f3702110,transparent)",
                borderRadius: 1,
              }}
            />
      ...
      {isA && b.englishLv56 && (
        <section
          ...
          style={{
            background:
              "linear-gradient(180deg,rgba(243,112,33,.03),transparent)",
              ...
              {b.englishLv56.levels.map((l, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <div
                      style={{ fontSize: 20, fontWeight: 900, color: l.color }}
                    >
                      {l.name}
                    </div>
                  </div>
        ...
        >
          <div className="gS">
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              >
                Hội Làng FPT &{" "}
                <span style={{ color: "#f37021" }}>Đại Nhạc Hội</span>
              </h2>
              <div className="gDiv" />
              <p
                style={{
            ...
            {b.events.hoiLang && (
              <div
                style={{
                  background:
                    "linear-gradient(135deg,rgba(243,112,33,.1),rgba(220,38,38,.06))",
                  ...
                  position: "relative",
                  overflow: "hidden",
                  animation: "gGlow 3s ease infinite",
                }}
              >
                <div
                  style={{
                  ...
                  >
                    <div
                      style={{
                        ...
                        filter: "drop-shadow(0 4px 12px rgba(243,112,33,.4))",
                      }}
                    >
                      🏮
                    </div>
        ...
        >
          <div className="gS">
            ...
            <div
              style={{
                background:
                  "linear-gradient(135deg,rgba(243,112,33,.1),rgba(243,112,33,.03))",
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 240 }}>
                ...
                <p style={{ fontSize: 13, color: "#94a3b8", lineHeight: 1.7 }}>
                  ...
                  tiếp quốc tế, sẵn sàng học chuyên ngành bằng tiếng Anh.
                </p>
              </div>
            </div>
      ...
      {isG && b.tyBa && (
        <section
          style={{
            background:
              "linear-gradient(180deg,rgba(245,158,11,.03),transparent)",
            borderTop: "1px solid #e2e8f0",
          }}
        >
          <div className="gS">
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              >
                Đàn Tỳ Bà &{" "}
                <span style={{ color: "#f59e0b" }}>Nhạc Cụ Truyền Thống</span>
              </h2>
              <div
                style={{
                  width: 48,
            ...
            <div
              style={{
                background:
                  "linear-gradient(135deg,rgba(245,158,11,.08),rgba(243,112,33,.04))",
            ...
            >
              ...
              >
                ...
                <p style={{ fontSize: 13, color: "#475569", lineHeight: 1.8 }}>
                  ...
                  FPT University là nơi tiên phong đưa nhạc cụ dân tộc vào giảng
                  dạy chính thức từ năm 2014.
                </p>
              </div>
            </div>
            ...
            >
              {[
                { n: "2014", l: "Năm bắt đầu", c: "#f37021" },
                { n: "46", l: "Giảng viên", c: "#f59e0b" },
                { n: "8", l: "Loại nhạc cụ", c: "#ea580c" },
                { n: "62%", l: "SV tham gia", c: "#ef4444" },
              ].map((s) => (
      ...
      >
        <div
          className="gS"
          style={{ textAlign: "center", paddingTop: 64, paddingBottom: 80 }}
        >
          <div
            style={{
              width: 80,
              ...
              justifyContent: "center",
              fontSize: 36,
              boxShadow: "0 8px 32px rgba(243,112,33,.35)",
              animation: "gFl 3s ease-in-out infinite",
            }}
          >
            {b.emoji}
