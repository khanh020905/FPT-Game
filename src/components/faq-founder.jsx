  ...
  return (
    <TimelineAnimation
      ...
      <button
        ...
        <span
          className="relative w-10 h-10 dark:bg-neutral-700 bg-white grid place-items-center rounded-lg shadow-sm">
          {!isOpen && <Plus size={20} />}
      ...
      <motion.div
        ...
        <div className="overflow-hidden">
          <p
            className="pb-6 text-sm sm:text-base text-neutral-600 dark:text-neutral-300 leading-relaxed">
            {answer}
          </p>
        </div>
      </motion.div>
        ...
        <div className="md:grid grid-cols-12  gap-8 md:gap-10">
          ...
          <TimelineAnimation
            ...
            <div className="flex gap-3 items-center">
              <div
                className="size-10 sm:size-16 rounded-xl overflow-hidden bg-neutral-300 dark:bg-neutral-700">
                <img src="/naymur.png" alt="profile" className="w-full h-full object-cover" />
              </div>

              <div>
                <h6
                  className="text-lg sm:text-xl font-semibold text-neutral-800 dark:text-white">
                  Naymur Rahman
                </h6>
            ...
            <p
              className="my-4 sm:my-5 text-base sm:text-lg text-neutral-700 dark:text-neutral-300">
            ...
            <button
              onClick={() =>
                window.open('https://www.linkedin.com/in/naymur-rahman/', '_blank')
              }
              ...
              <svg preserveAspectRatio="xMidYMid" viewBox="0 0 256 256" className="w-6">
                <path
